...
DeviceNetAnalyzerResults::~DeviceNetAnalyzerResults()
{
}

void DeviceNetAnalyzerResults::GenerateBubbleText( U64 frame_index, Channel& channel, DisplayBase display_base )
{
	ClearResultStrings();
